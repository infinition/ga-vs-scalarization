...
% Placeholder box shown while a figure file is missing.
\newcommand{\figplaceholder}[2]{%
  \IfFileExists{#1}{\includegraphics[width=#2]{#1}}{%
    \fbox{\parbox[c][14em][c]{#2}{\centering PENDING FIGURE\\ \texttt{#1}}}}}
...
and their pairwise cross products and the $c_j$ are functions of the pairwise
dot products~\citep{villar2021scalars}. Learning the $c_j$ with a small MLP
gives an exactly equivariant model that we call \emph{scalarization}.
...
\begin{figure}[t]
\centering
\figplaceholder{figures/sample_efficiency.pdf}{0.85\linewidth}
...
\begin{figure}[t]
\centering
\figplaceholder{figures/overview.pdf}{0.95\linewidth}
